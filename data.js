const userDetails = {
  ...
  description:
    "A multi-skilled and dedicated IT professional with over %expYears% years of experience, adept in software development, well-versed in different programming languages. Well-rounded experience in OOPs, mobile development and user-centered design. A prodigy in learning new technologies. Strong background in team management and delegation.",
  picture: {
    src: "raj.jpeg",
...
const experiences = [
  {
    ...
    achievements: [
      "Designed and developed microservices using Golang (gRPC)",
      "Developed applications for Android and iOS using Flutter framework",
      "Developed elegant and user-friendly web applications using React.JS",
  ...
  },
  {
    ...
    achievements: [
      "Designed and developed microservices using Django framework",
      "Developed applications for Android and iOS using Flutter framework",
...
const personalProjects = [
  ...
  },
  {
    ...
    description:
      "Check whether the device rooted/Jail broken, is an Emulator, has Developer mode on (Android only), is app installed on external storage (Android only)",
    duration: "Aug 2021",
...
const companyProjects = [
  {
    name: "Nexus Ventures",
    description:
      "Nexus ventures application for internal financial data records and reporting.",
  ...
  },
  {
    name: "Urdu Audio",
    description:
      "Urdu audio is an audio streaming mobile application available on Android and iOS platform.",
